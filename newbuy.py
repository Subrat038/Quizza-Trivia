...
class Bot(discord.Client):
    ...
    async def update_embeds(self):
      #  global wrong
        ...
        self.embed.set_field_at(0, name="**__ANSWER  1__**", value="**{0}.0**{1}".format(lst_scores[0], one_check))
        
        self.embed.set_field_at(1, name="**__ANSWER  2__**", value="**{0}.0**{1}".format(lst_scores[1], two_check))
        
        self.embed.set_field_at(2, name="**__ANSWER  3__**", value="**{0}.0**{1}".format(lst_scores[2], three_check),)
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NzAzNDYyOTk0OTg5ODA5NzA0.XqO9SA.6jmzMVZuEw1z100tKtwpGw7oR84',
                                   bot=False))
    loop.run_forever()
